      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 sm:mb-12 gap-3 sm:gap-4">
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="bg-slate-900 p-2.5 sm:p-3 rounded-xl sm:rounded-2xl shadow-xl shadow-slate-200 shrink-0"><Clock className="w-5 h-5 sm:w-6 sm:h-6 text-white" aria-hidden="true" /></div>
            <div>
          ...
          <div className="text-[10px] sm:text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 sm:gap-3 bg-slate-50 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-slate-100 shadow-inner"><MousePointer2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-indigo-500" aria-hidden="true" /> 向右滑动追溯历史</div>
        </div>
        ...
        <div className="relative" aria-label="AI 行业时间线">
          ...
          <div className="flex gap-4 sm:gap-6 lg:gap-8 overflow-x-auto pb-6 sm:pb-10 pt-4 snap-x relative z-10 px-2 sm:px-4 custom-scrollbar">
            ...
            <div className="flex-shrink-0 w-[60px] sm:w-[100px] flex justify-center pt-[-2px] sm:pt-0"><InfinityIcon className="w-8 h-8 sm:w-10 sm:h-10 text-slate-200 bg-white relative z-10" aria-hidden="true" /></div>
          </div>
        </div>
