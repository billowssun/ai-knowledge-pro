    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm" role="banner">
      <div className="max-w-[1400px] mx-auto px-3 sm:px-6 h-14 sm:h-20 lg:h-24 flex items-center justify-between gap-2 sm:gap-4 lg:gap-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <div className="bg-slate-900 p-1.5 sm:p-2 lg:p-2.5 rounded-lg sm:rounded-xl text-white shadow-lg" aria-hidden="true">
        ...
        <nav className="flex gap-1.5 sm:gap-2 lg:gap-3 overflow-x-auto no-scrollbar py-2 sm:py-3 lg:py-4 px-1 sm:px-2 flex-1 scroll-smooth min-w-0" aria-label="领域导航">
          {domainsData.map((domain) => {
            ...
            return (
              ...
              >
                <Icon className={`w-3 h-3 sm:w-3.5 sm:h-3.5 lg:w-4 lg:h-4 shrink-0 ${isActive ? 'text-indigo-400' : 'text-slate-400'}`} aria-hidden="true" />
