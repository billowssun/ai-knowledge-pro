...
const domainsData = [
  {
    ...
    vendors: [
      ...
      { id: "v-deepseek", name: "DeepSeek", logo: <BrainCircuit className="w-6 h-6 text-blue-600" />, origin: "国产先锋", desc: "开源之光", models: [
      ...
      { id: "v-zhipu", name: "智谱 AI", logo: <CpuIcon className="w-6 h-6 text-purple-500" />, origin: "国产先锋", desc: "学术派巨头", models: [
  ...
  },
  {
    ...
    vendors: [
      ...
      { id: "a-suno", name: "Suno / Udio", logo: <Sparkles className="w-6 h-6 text-pink-500" />, origin: "独立团队", desc: "流行乐之皇", models: [
